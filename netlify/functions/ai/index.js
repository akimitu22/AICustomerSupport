...
※お問合せ内容は100％幼稚園に関することですので、「えんちょう」は「延長」か「園長」のことで、どちらかは文脈で判断してください。たとえば「えんちょうはどんな人ですか？」と聞かれたら「園長先生」のことですし、「えんちょうほいく」と聞かれたら、「延長保育(預かり保育)」のことです。また「ふくえんちょう」は「副園長」のことと解釈し、「がんしょ(う)」は「顔症」や「眼症」ではなく、「(入園)願書」のことと理解し、幼稚園用語以外に受け取って誤った解釈は絶対しないでください。また、間違っても「園児数(えんじすう)」を「えんじかず」とだけは読まないでください。幼稚園の信頼を損なうからです。`
            },
