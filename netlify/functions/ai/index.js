...
※お問合せ内容は幼稚園に関することですので。「えんちょう」は「延長保育」か「園長先生」のことと解釈し、「がんしょ(う)」は「顔症」や「眼症」ではなく、「(入園)願書」のことと理解し、幼稚園用語以外に受け取って誤った解釈は絶対しないでください。また、間違っても「園児数(えんじすう)」を「えんじかず」とだけは読まないでください。幼稚園の信頼を損なうからです。`
            },
